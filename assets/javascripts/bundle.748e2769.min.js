  ...
  {case"p":case",":let t=ue("[href][rel=prev]");typeof t!="undefined"&&t.click();break;case"n":case".":let
      ...
      mr=Ze.pipe(m(()=>Se("main")),x(e=>di(e,{viewport$:we,header$:qe})),X(1)),Hs=C(...ne("dialog")
          ...
          ("data-md-type")==="navigation"?zr(Wi,()=>Xr(e,{viewport$:we,header$:qe,main$:mr})):zr(hr,()=>
              Xr(e,{viewport$:we,header$:qe,main$:mr}))),...ne("tabs").map(e=>Pi(e,{viewport$:we,header$:qe})),
          ...ne("toc").map(e=>Ii(e,{viewport$:we,header$:qe,target$:Tt})),...ne("top").
          map(e=>$i(e,{viewport$:we,header$:qe,main$:mr,target$:Tt})))),qi=Ze.pipe(x(()=>Ps),
          Xe(Hs),X(1));qi.subscribe();window.document$=Ze;window.location$=dr;window.target$=Tt;window.keyboard$=Zr;
          window.viewport$=we;window.tablet$=hr;window.screen$=Wi;window.print$=Vi;window.alert$=en;window.component$=qi;})();
